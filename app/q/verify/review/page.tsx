        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-6">
            ...
            <p className="text-amber-800 text-[15px] leading-relaxed mb-3">
              Based on your eligibility review, most Medicare Supplement carriers will likely decline a new application. <span className="font-semibold">We recommend staying with your current plan</span> — your existing coverage cannot be taken away due to prior coverage history.
            </p>
